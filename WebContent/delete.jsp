...
<%
	...
	%>
<form class="login100-form validate-form" action="deleteService.jsp"method="post">
	<div class="limiter">
		<div class="container-login101">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
					<span class="login100-form-title p-b-55"> 회원탈퇴 </span>
					<span class="login100-form-title p-b-55"> 당신의 모든 정보가 지워집니다. 비밀번호를 입력하시면 탈퇴할 수 있습니다.</span>
