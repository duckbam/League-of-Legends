...
<%
	...
	if(session.getAttribute("email").equals(email2) == false){
		out.print("<script>alert('작성자만 수정 가능합니다.'); location.href='list.jsp';</script>");
		return;
	}
...
%>
	<h1 style="margin-bottom: 30px;">문의 수정</h1>
		...
		<table id="write_table" style="margin: auto;" class="table table-hover w-50"> 	
			...
			<tr id="write_row2">
				<td class="col1">제목</td>
				<td class="col2"> <input type="text" class="form-control" name="subject" value="<%=subject%>"> </td>
			</tr>
			
			<tr id="write_row3">
				<td class="col1">내용</td>
				<td class="col2" style="height: 300px;"><textarea name="content" wrap="hard" class="form-control h-100"><%=content %></textarea></td>
			</tr>
			...
			<input style="margin-top: 20px;" type="image" src="/lol/img/ok.png">
	</form>
</main>
